...
api.show = {
    ...
    "episode/seen": { type: "POST", auth: false, params: [arg("imdb_id", true), arg("tvdb_id", true), arg("title", true), arg("year", true), arg("episodes")] },
    ...
    "library": { type: "POST", auth: false, params: [arg("imdb_id", true), arg("tvdb_id", true), arg("title", true), arg("year", true)] },
    "related": { type: "GET", params: [arg("title"), arg("hidewatched", true)] },
    ...
    "season/seen": { type: "POST", auth: false, params: [arg("imdb_id", true), arg("tvdb_id", true), arg("title", true), arg("year", true), arg("season")] },
    ...
    "summaries": { type: "GET", params: [arg("title"), arg("extended", true)] },
    "unlibrary": { type: "POST", auth: false, params: [arg("imdb_id", true), arg("tvdb_id", true), arg("title", true), arg("year", true)] },
    "unwatchlist": { type: "POST", auth: false, params: [arg("shows")] },
    ...
    "watchingnow": { type: "GET", params: [arg("title")] },
    "watchlist": { type: "POST", auth: false, params: [arg("shows")] }
};
